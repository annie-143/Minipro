...
// Query to fetch 
$sql = "SELECT id, pet_image, pet_name,description,location,contact_number,stat FROM missing_pets WHERE uid = '$user_id'";
...
<head>
  ...
  <title>PetConnect | View Pets</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">View Missing Post</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Missing Posts</h5>
                ...
                <tbody>
                  ...
                  if ($result->num_rows > 0) {
                      while ($row = $result->fetch_assoc()) {
                          echo '<tr>';
                          echo '    <td><img src="uploads/product/' . htmlspecialchars($row["pet_image"]) . '" alt="' . htmlspecialchars($row["pet_name"]) . '" class="img-thumbnail" style="width: 100px;"></td>';
                          ...
                          echo '  <td>                                  
                                    ...
                                    <form action="del_miss.php" method="POST">
